...
class Listprofileimglarg5ItemWidget extends StatelessWidget {
  Listprofileimglarg5ItemWidget(this.listprofileimglarg5ItemModelObj);

  Listprofileimglarg5ItemModel listprofileimglarg5ItemModelObj;

  var controller = Get.find<FacebookFeedsDisplayController>();
